...
vocabulary_size = len(set(words)) - 100
...
print('max index:',max(reverse_dictionary.keys()))
...
for n in range(com_n):
    com_s += ' ' + count[:com_n][n][0]
print(com_s)
